...
- `mcpapp/` — importable embedded JS/CSS asset bundles + canvas renderer for
  MCP-hosted UIs (shared with hosted composition roots; `internal/mcpapp/` is a
  thin re-export alias)
