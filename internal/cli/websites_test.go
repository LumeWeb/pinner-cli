...
// sOrEmpty dereferences a *string, returning "" for nil. Shared with the
// retired websites handler test helper (websites_handler_test.go), this is
// still used by the website service mock in this file.
