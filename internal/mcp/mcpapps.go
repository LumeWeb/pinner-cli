...
// object, advertising RESOURCE_MIME_TYPE so a UI-capable host knows to render
// ui:// resources. When wiring a real app tool, pass the returned
...
func AdvertiseUICapability(caps *mcp.ServerCapabilities) *mcp.ServerCapabilities {
	...
	caps.AddExtension(EXTENSION_ID, map[string]any{
		"mimeTypes": []string{RESOURCE_MIME_TYPE},
	})
	return caps
}
