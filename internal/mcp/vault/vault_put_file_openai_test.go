...
func openaiVaultDesc(t *testing.T, coLocated bool, httpClient *http.Client) model.ToolDescriptor {
	t.Helper()
	return newVaultPutFileDescriptor(coLocated, false, nil, nil, func(ctx context.Context, r io.Reader, sz int64, vaultPath string) (any, error) {
...
func TestVaultPutFileOpenAIFetch(t *testing.T) {
	...
	desc := newVaultPutFileDescriptor(false, false, nil, nil, func(ctx context.Context, r io.Reader, sz int64, vaultPath string) (any, error) {
		b, err := io.ReadAll(r)
...
func TestVaultPutFileOpenAIFetchWorksOnEveryTransport(t *testing.T) {
	...
	var gotBytes []byte
	desc := newVaultPutFileDescriptor(true, false, nil, nil, func(ctx context.Context, r io.Reader, sz int64, vaultPath string) (any, error) {
		b, _ := io.ReadAll(r)
		gotBytes = b
		return map[string]any{"vault_path": vaultPath}, nil
	}, []string{"127.0.0.1"}, 0, srv.Client())
