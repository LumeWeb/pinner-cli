...
func buildOpenAIFileDesc(t *testing.T, srv *httptest.Server, maxBytes int64) (model.ToolDescriptor, *[]byte, *string) {
	...
	var gotBytes []byte
	var gotName string
	desc := newUploadFileDescriptor(transportFeatures(false, false), false, false, nil, nil, func(ctx context.Context, reader io.Reader, sz int64, name string, wait bool, _ string, _ bool) (any, error) {
...
func TestUploadFileDescriptorOpenAIFileRunOnEveryTransport(t *testing.T) {
	...
	srv := openaiFetchServer(t, []byte(openaiTestPayload))
	var gotBytes []byte
	desc := newUploadFileDescriptor(transportFeatures(true, false), true, false, nil, nil, func(ctx context.Context, reader io.Reader, sz int64, name string, wait bool, _ string, _ bool) (any, error) {
...
func TestUploadFileDescriptorOpenAIFileThreadsArchiveMode(t *testing.T) {
	...
	srv := openaiFetchServer(t, []byte(openaiTestPayload))
	desc := newUploadFileDescriptor(transportFeatures(false, false), false, false, nil, nil, func(ctx context.Context, reader io.Reader, sz int64, name string, wait bool, archiveMode string, _ bool) (any, error) {
