...
// upload-package launcher descriptions (composed through the shared
// apps.OpenLauncherDescriptionBody skeleton, with the vault body carrying the
// canonical mintcontract durability fragments) so the wire text stays stable
// across refactors.
