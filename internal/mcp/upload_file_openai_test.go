...
func stdioFileDesc() model.ToolDescriptor {
	return transfer.NewUploadFileDescriptor(true, false, func(ctx context.Context, path, name string, wait bool, archiveMode string) (any, error) {
...
func openAIFileDesc(t *testing.T) model.ToolDescriptor {
	t.Helper()
	return transfer.NewUploadFileDescriptor(true, false, nil, nil, func(ctx context.Context, r io.Reader, sz int64, name string, wait bool) (any, error) {
...
func TestUploadFileOpenAIMetaCoexistsWithAppUI(t *testing.T) {
	mgr := transfer.NewUploadTaskManager(func(_ context.Context, _ io.Reader, _ int64, _ string, _ bool) (any, error) {
