...
type QuotaAdminServiceFactory func(cfgMgr config.Manager) QuotaAdminService

// BillingAdminServiceFactory creates a BillingAdminService with dependencies.
type BillingAdminServiceFactory func(cfgMgr config.Manager) BillingAdminService

// WebsiteAdminServiceFactory creates a WebsiteAdminService with dependencies.
type WebsiteAdminServiceFactory func(cfgMgr config.Manager) WebsiteAdminService

// ProfilingAdminServiceFactory creates a ProfilingAdminService with dependencies.
type ProfilingAdminServiceFactory func(cfgMgr config.Manager) ProfilingAdminService

// defaultQuotaAdminServiceFactory creates a default QuotaAdminService instance.
func DefaultQuotaAdminServiceFactory(cfgMgr config.Manager) QuotaAdminService {
	return NewQuotaAdminService(cfgMgr, cfgMgr.Config().GetAdminEndpoint())
}

// defaultBillingAdminServiceFactory creates a default BillingAdminService instance.
func DefaultBillingAdminServiceFactory(cfgMgr config.Manager) BillingAdminService {
	return NewBillingAdminService(cfgMgr, cfgMgr.Config().GetAdminEndpoint())
}

// defaultWebsiteAdminServiceFactory creates a default WebsiteAdminService instance.
func DefaultWebsiteAdminServiceFactory(cfgMgr config.Manager) WebsiteAdminService {
	return NewWebsiteAdminService(cfgMgr, cfgMgr.Config().GetAdminEndpoint())
}

// defaultProfilingAdminServiceFactory creates a default ProfilingAdminService instance.
func DefaultProfilingAdminServiceFactory(cfgMgr config.Manager) ProfilingAdminService {
	return NewProfilingAdminService(cfgMgr, cfgMgr.Config().GetAdminEndpoint())
}
...
func NewQuotaAdminService(cfgMgr config.Manager, apiEndpoint string) QuotaAdminService {
...
func NewBillingAdminService(cfgMgr config.Manager, apiEndpoint string) BillingAdminService {
...
func NewWebsiteAdminService(cfgMgr config.Manager, apiEndpoint string) WebsiteAdminService {
...
func NewProfilingAdminService(cfgMgr config.Manager, apiEndpoint string) ProfilingAdminService {
