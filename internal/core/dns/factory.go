...
// DefaultFactory builds a DNS Service using the config-derived endpoint.
...
// NewAuthenticated builds a DNS Service with the supplied auth token, requiring
// that the resulting service is authenticated.
