...
func registerCustomTools(deps customToolDeps) error {
	...
	// search/describe/invoke, instead of a separate RegisterOfficialDescriptor +
	// catalog.Add dance. When the wizard transport is absent oob is nil and both
	// tools return a structured not-configured hand-off instead of hanging.
