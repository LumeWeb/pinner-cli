...
func (_mock *MockOperationsService) Get(ctx context.Context, id int64) (*OperationDetail, error) {
	...
	var r0 *OperationDetail
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int64) (*OperationDetail, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int64) *OperationDetail); ok {
		r0 = returnFunc(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*OperationDetail)
		}
	}
...
func (_mock *MockOperationsService) List(ctx context.Context, opts OperationsListOptions) (*OperationsListResult, error) {
	...
	var r0 *OperationsListResult
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, OperationsListOptions) (*OperationsListResult, error)); ok {
		return returnFunc(ctx, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, OperationsListOptions) *OperationsListResult); ok {
		r0 = returnFunc(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*OperationsListResult)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, OperationsListOptions) error); ok {
...
func (_c *MockOperationsService_List_Call) Run(run func(ctx context.Context, opts OperationsListOptions)) *MockOperationsService_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 OperationsListOptions
		if args[1] != nil {
			arg1 = args[1].(OperationsListOptions)
		}
		run(
			arg0,
			arg1,
